    ...
    'options-tab': {
        ...
        <table>
            <tr>
                ...
                <td><button class="opt" onclick="toggleOpt('hqTree')">HD Mode: {{ options.hqTree?"ON":"OFF" }}</button></td>
				<td><button class="opt" onclick="toggleOpt('forceOneTab'); needsCanvasUpdate = true">Single-Tab Mode: {{ options.forceOneTab?"ALWAYS":"AUTO" }}</button></td>
            
            </tr><br>
				<td><button class="opt" onclick="hardReset()">See The Intro Screen Again</button></td>             
        </table>`
    },
